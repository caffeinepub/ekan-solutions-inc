  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen font-sans", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "section",
      {
        ...
        style: {
          background: "linear-gradient(135deg, #0A3D62 0%, #0d5a8a 60%, #073350 100%)"
        },
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "nav",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#1ABC9C] font-medium", children: "About Us" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl fade-in-up", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-5xl sm:text-6xl font-extrabold text-white leading-tight mb-4", children: "We Are Ekan Solutions" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl font-semibold text-[#1ABC9C] mb-6", children: "Maryland's Trusted IT Partner Since 2010" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/75 text-lg leading-relaxed mb-10 max-w-2xl", children: "We deliver enterprise-grade cybersecurity, cloud, development, and project management solutions — built on integrity, powered by innovation." }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-24 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-16 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fade-in-up", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fade-in-up", style: { transitionDelay: "0.15s" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block text-xs font-bold uppercase tracking-widest text-[#1ABC9C] mb-3", children: "Our Story" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl font-extrabold text-[#0A3D62] leading-tight mb-6", children: "From Vision to Enterprise Reality" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 text-gray-600 leading-relaxed mb-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Founded in 2010, Ekan Solutions Inc. is a Maryland-based software consulting and development firm. We blend strategic thinking with deep technical expertise to solve the most complex enterprise IT challenges." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Our team carries over 35 years of combined experience, backed by a dedicated 24/7 offshore development center. We have proudly served clients across healthcare, insurance, government, finance, manufacturing, and transportation." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "What sets us apart is our people — experts who bring curiosity, commitment, and integrity to every engagement, ensuring our clients stay ahead in a rapidly evolving technology landscape." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 bg-[#0A3D62]/[0.08] rounded-xl px-5 py-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2 h-2 rounded-full bg-[#1ABC9C]" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-bold text-[#0A3D62]", children: "Founded 2010" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 bg-[#0A3D62]/[0.08] rounded-xl px-5 py-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2 h-2 rounded-full bg-[#1ABC9C]" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-bold text-[#0A3D62]", children: "HQ Maryland, USA" })
          ] })
        ] })
      ] })
    ] }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16", style: { background: "#071e31" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-8 text-center", children: STATS$1.map((stat, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl sm:text-5xl font-extrabold text-[#1ABC9C] mb-2", children: stat.number }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white/70 font-medium text-sm uppercase tracking-wide", children: stat.label })
        ]
      },
      stat.label
    )) }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-24", style: { background: "#f4f6f9" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14 fade-in-up", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block text-xs font-bold uppercase tracking-widest text-[#1ABC9C] mb-3", children: "Our Direction" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl font-extrabold text-[#0A3D62]", children: "Mission & Vision" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-2xl bg-[#1ABC9C]/15 flex items-center justify-center mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { className: "w-6 h-6 text-[#1ABC9C]" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-extrabold text-[#0A3D62] mb-4", children: "Our Mission" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 leading-relaxed", children: "To empower organizations with cutting-edge technology solutions, expert services, and continuous education — enabling superior performance and lasting competitive advantage." })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-2xl bg-[#1ABC9C]/15 flex items-center justify-center mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Lightbulb, { className: "w-6 h-6 text-[#1ABC9C]" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-extrabold text-[#0A3D62] mb-4", children: "Our Vision" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 leading-relaxed", children: "To be the most trusted technology partner for enterprise clients — known for integrity, innovation, and delivering measurable results." })
            ]
          }
        )
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-24 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14 fade-in-up", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block text-xs font-bold uppercase tracking-widest text-[#1ABC9C] mb-3", children: "What Drives Us" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl font-extrabold text-[#0A3D62]", children: "The Values We Live By" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-6", children: VALUES.map((val, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          "data-ocid": `about.item.${i + 1}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-full bg-[#1ABC9C]/15 flex items-center justify-center mb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(val.icon, { className: "w-6 h-6 text-[#1ABC9C]" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-lg font-extrabold text-[#0A3D62] mb-3", children: val.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 leading-relaxed text-sm", children: val.desc })
          ]
        },
        val.title
      )) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-24", style: { background: "#0A3D62" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fade-in-up mb-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block text-xs font-bold uppercase tracking-widest text-[#1ABC9C] mb-3", children: "Our Reach" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl font-extrabold text-white", children: "Industries We Serve" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          style: { transitionDelay: "0.1s" },
          children: INDUSTRIES$1.map((industry, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-24 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center fade-in-up", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Quote, { className: "w-12 h-12 text-[#1ABC9C] mx-auto mb-8" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("blockquote", { className: "text-2xl sm:text-3xl font-bold text-[#0A3D62] leading-snug mb-6", children: '"To provide every client around the world with best-in-class solutions, dedicated service, and genuine care. We show up with respect, expertise, and a relentless commitment to your success."' }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 font-medium", children: "— Ekan Solutions Inc., Founded 2010" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        "data-ocid": "about.panel",
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center fade-in-up", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl sm:text-5xl font-extrabold text-white mb-5", children: "Ready to Transform Your Business?" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/70 text-lg mb-10", children: "Let's discuss how Ekan Solutions can help you achieve your technology goals." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col sm:flex-row items-center justify-center gap-5 mb-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-center justify-center gap-6 text-white/60 text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                href: "tel:8322950408",
...
const STATS = [
  ...
  { icon: ChartColumn, value: "24/7", label: "Support" }
];
const PROCESS_STEPS$1 = [
  {
    num: "01",
    icon: Search,
    title: "Analyze",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen", children: [
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "absolute inset-0 opacity-10",
              style: {
                backgroundImage: "radial-gradient(circle at 20% 50%, #1ABC9C 0%, transparent 50%), radial-gradient(circle at 80% 20%, #1e6fa0 0%, transparent 40%)"
              }
            }
          ),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "nav",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-medium", children: "Services" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 bg-[#1ABC9C]/20 border border-[#1ABC9C]/40 text-[#1ABC9C] text-sm font-semibold px-4 py-1.5 rounded-full mb-6", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { className: "w-4 h-4" }),
                "Enterprise IT Solutions"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-5xl md:text-6xl font-bold leading-tight mb-6", children: "Our IT Services" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl text-blue-200 mb-10 max-w-2xl leading-relaxed", children: "Enterprise-grade technology solutions tailored to drive your business forward." }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Button,
                  {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14 fade-in-up", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[#1ABC9C] font-semibold uppercase tracking-widest text-sm mb-3", children: "What We Offer" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl font-bold text-[#0A3D62] mb-4", children: "Core Service Areas" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 max-w-2xl mx-auto text-lg", children: "Five specialized practice areas designed to address your most critical technology challenges." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8", children: SERVICES_OVERVIEW.map((svc, i) => {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-7 h-7 text-white" })
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-[#0A3D62] mb-3", children: svc.title }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 leading-relaxed flex-1", children: svc.desc }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      type: "button",
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "div",
                          {
                            ...
                            style: { backgroundColor: svc.color },
                            children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-12 h-12 text-white" })
                          }
                        ),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "p",
                          {
                            ...
                            children: SERVICES_OVERVIEW[i].title
                          }
                        )
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `fade-in-up ${isEven ? "lg:order-1" : ""}`, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      className: "w-12 h-12 rounded-xl flex items-center justify-center mb-5",
                      style: { backgroundColor: svc.color },
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-6 h-6 text-white" })
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-bold text-[#0A3D62] mb-5 leading-snug", children: svc.title }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 text-lg leading-relaxed mb-7", children: svc.body }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3", children: svc.bullets.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      CircleCheck,
                      {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-700", children: b })
                  ] }, b)) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    Button,
                    {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12 fade-in-up", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[#1ABC9C] font-semibold uppercase tracking-widest text-sm mb-3", children: "Tools & Platforms" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-bold text-[#0A3D62]", children: "Technologies We Work With" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fade-in-up flex flex-wrap justify-center gap-3", children: TECH_STACK.map((tech) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-8", children: STATS.map((stat, i) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 bg-[#1ABC9C]/20 rounded-xl flex items-center justify-center mx-auto mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-6 h-6 text-[#1ABC9C]" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-4xl font-bold text-white mb-1", children: stat.value }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-blue-300 text-sm", children: stat.label })
              ]
            },
            stat.label
          );
      ...
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16 fade-in-up", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[#1ABC9C] font-semibold uppercase tracking-widest text-sm mb-3", children: "Our Methodology" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl font-bold text-[#0A3D62] mb-4", children: "How We Work" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 max-w-xl mx-auto", children: "A proven 5-step delivery framework that guarantees results on every engagement." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden lg:block absolute top-16 left-[10%] right-[10%] h-px border-t-2 border-dashed border-gray-200" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8", children: PROCESS_STEPS$1.map((step, i) => {
                ...
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative inline-block mb-5", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-2xl bg-[#0A3D62] flex items-center justify-center mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-8 h-8 text-white" }) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -top-2 -right-2 bg-[#1ABC9C] text-white text-xs font-bold px-2 py-0.5 rounded-full", children: step.num })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-bold text-[#0A3D62] mb-2", children: step.title }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        style: {
          background: "linear-gradient(135deg, #0A3D62 0%, #0d4f7a 50%, #0A3D62 100%)"
        },
        "data-ocid": "services.cta.section",
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto text-center fade-in-up", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 bg-[#1ABC9C]/20 rounded-2xl flex items-center justify-center mx-auto mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Rocket, { className: "w-8 h-8 text-[#1ABC9C]" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl md:text-5xl font-bold text-white mb-5", children: "Ready to Transform Your Business?" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl text-blue-200 mb-10 max-w-2xl mx-auto", children: "Talk to our experts and get a customized IT strategy for your organization." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-4 justify-center", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "tel:8322950408", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                variant: "outline",
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "mr-2 w-4 h-4" }),
                  " Call Us Now"
                ]
              }
            ) })
...
function Header({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "header",
    {
      className: `fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "bg-white shadow-md py-3" : "bg-white/95 backdrop-blur py-4"}`,
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              "data-ocid": "nav.link",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 bg-navy rounded flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { className: "w-5 h-5 text-white" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-lg text-navy leading-none block", children: "Ekan Solutions" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-500 leading-none", children: "Inc." })
                ] })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden lg:flex items-center gap-7", children: NAV_LINKS.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
        ...
        menuOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:hidden mt-4 pb-4 border-t border-gray-100", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "flex flex-col gap-3 mt-4", children: [
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              backgroundImage: "url('/assets/generated/ekan-hero-bg.dim_1600x800.jpg')",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-12 items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fade-in-up", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 bg-white/10 border border-white/20 rounded-full px-4 py-1.5 mb-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-[#1ABC9C] animate-pulse" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white/90 text-sm font-medium", children: "Trusted IT Partner Since 2009" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-tight mb-6", children: [
              "Empowering Business",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#1ABC9C]", children: "Through Technology" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/75 text-lg leading-relaxed mb-8 max-w-lg", children: "Ekan Solutions delivers enterprise IT services—cybersecurity, cloud, development, and project management—that transform complexity into competitive advantage." }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-6", children: [
              { icon: ChartColumn, value: "500+", label: "Projects Delivered" },
              { icon: Clock, value: "15+", label: "Years Experience" },
              { icon: Users, value: "24/7", label: "Expert Support" }
            ].map((trust) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full bg-white/10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(trust.icon, { className: "w-5 h-5 text-[#1ABC9C]" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white font-bold text-lg leading-none", children: trust.value }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white/60 text-xs", children: trust.label })
              ] })
            ] }, trust.label)) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/10 backdrop-blur border border-white/20 rounded-2xl p-8", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-white font-bold text-xl mb-6", children: "Core Services" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: SERVICES.map((svc) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "div",
                          {
                            ...
                            style: {
                              backgroundColor: svc.color === "#1ABC9C" ? "rgba(26,188,156,0.25)" : "rgba(255,255,255,0.15)"
                            },
                            children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                              svc.icon,
                              {
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-medium text-sm", children: svc.title }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "w-4 h-4 text-white/40 ml-auto" })
                      ]
                    },
                    svc.title
                  )) })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-6 -right-6 w-24 h-24 bg-[#1ABC9C]/30 rounded-full blur-2xl" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -bottom-6 -left-6 w-32 h-32 bg-white/10 rounded-full blur-2xl" })
              ] })
            }
          )
        ] }) }),
...
function IntroCards() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative z-10 bg-white pb-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-6", children: [
    {
      icon: Layers,
      title: "Our Services",
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(card.icon, { className: "w-6 h-6", style: { color: card.color } })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-xl text-[#0A3D62] mb-2", children: card.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-sm leading-relaxed", children: card.desc })
      ]
    },
    card.title
  )) }) }) });
...
function AboutSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", className: "py-24 bg-white", "data-ocid": "about.section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16 fade-in-up", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block text-[#1ABC9C] font-semibold text-sm uppercase tracking-widest mb-3", children: "Who We Are" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl font-extrabold text-[#0A3D62] mb-4", children: "About Ekan Solutions" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 max-w-xl mx-auto", children: "A technology partner built on integrity, innovation, and 15+ years of enterprise expertise." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-16 mb-14", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fade-in-up", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block text-xs font-bold uppercase tracking-widest text-[#1ABC9C] mb-4", children: "Our Story" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 leading-relaxed mb-4", children: "Founded in 2010, Ekan Solutions Inc. is a Maryland-based software consulting and development firm specializing in enterprise IT services. We blend strategic thinking with deep technical expertise to tackle the most complex business challenges." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 leading-relaxed", children: "Our team brings over 35 years of combined experience, supported by a dedicated 24/7 offshore development center. We serve clients across healthcare, insurance, government, finance, and more—delivering solutions that are scalable, secure, and built to last." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block text-[#1ABC9C] text-xs font-bold uppercase tracking-widest mb-2", children: "Our Mission" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/85 leading-relaxed text-sm", children: "To empower organizations with cutting-edge technology solutions, expert services, and continuous education—enabling superior performance and lasting competitive advantage." })
            ]
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fade-in-up", style: { transitionDelay: "0.15s" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block text-xs font-bold uppercase tracking-widest text-[#1ABC9C] mb-4", children: "Our Values" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-4", children: ABOUT_VALUES.map((value, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: `border border-gray-100 rounded-xl p-5 hover:shadow-md transition-shadow duration-300 ${i === 4 ? "col-span-2 sm:col-span-1 sm:col-start-1 md:col-span-2 lg:col-span-1 lg:col-start-1" : ""}`,
            "data-ocid": `about.item.${i + 1}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-full bg-[#1ABC9C]/15 flex items-center justify-center mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(value.icon, { className: "w-4 h-4 text-[#1ABC9C]" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-[#0A3D62] text-sm mb-1.5", children: value.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-xs leading-relaxed", children: value.desc })
            ]
          },
          value.title
        )) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fade-in-up mb-10", style: { transitionDelay: "0.2s" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center mb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block text-xs font-bold uppercase tracking-widest text-[#1ABC9C]", children: "Industries We Serve" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 justify-center", children: INDUSTRIES.map((industry) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
          ...
          onMouseLeave: (e) => {
            e.currentTarget.style.backgroundColor = "rgba(10,61,98,0.05)";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        style: { transitionDelay: "0.3s" },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-extrabold text-[#0A3D62] mb-1", children: "Our Promise to You" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 max-w-2xl mx-auto leading-relaxed", children: "To provide clients worldwide with best-in-class solutions, services, and expertise. Every interaction is guided by care, respect, and a relentless focus on results." })
        ]
      }
    )
  ] }) });
...
function ServicesSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "services", className: "py-24 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16 fade-in-up", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block text-[#1ABC9C] font-semibold text-sm uppercase tracking-widest mb-3", children: "What We Do" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl font-extrabold text-[#0A3D62] mb-4", children: "Our Core Services" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 max-w-xl mx-auto", children: "Comprehensive IT solutions engineered to protect, optimize, and accelerate your business." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6", children: SERVICES.map((svc, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(svc.icon, { className: "w-7 h-7", style: { color: svc.color } })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-[#0A3D62] mb-2 text-base", children: svc.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-xs leading-relaxed", children: svc.desc })
        ]
      },
      svc.title
    )) })
    ...
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14 fade-in-up", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block text-[#1ABC9C] font-semibold text-sm uppercase tracking-widest mb-3", children: "Our Edge" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl font-extrabold text-white mb-4", children: "Why Choose Ekan Solutions?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/65 max-w-xl mx-auto", children: "We combine technical depth with strategic thinking to deliver IT solutions that actually move the needle." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-8", children: [
            ...
            "div",
            {
              ...
              style: { transitionDelay: `${i * 0.15}s` },
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-xl bg-[#1ABC9C]/20 flex items-center justify-center mb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(card.icon, { className: "w-6 h-6 text-[#1ABC9C]" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-white text-xl mb-3", children: card.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/65 text-sm leading-relaxed", children: card.desc })
              ]
            },
            card.title
          )) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-16 grid grid-cols-2 md:grid-cols-4 gap-6 fade-in-up", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl font-extrabold text-[#1ABC9C] mb-1", children: stat.value }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white/65 text-sm", children: stat.label })
          ] }, stat.label)) })
        ] })
      ]
    }
...
function ServiceDetails() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-24 bg-gray-50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14 fade-in-up", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block text-[#1ABC9C] font-semibold text-sm uppercase tracking-widest mb-3", children: "Deep Dive" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl font-extrabold text-[#0A3D62] mb-4", children: "Service Details" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 max-w-xl mx-auto", children: "Explore what's included in each of our specialized practice areas." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fade-in-up", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "cybersecurity", className: "w-full", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsList, { className: "flex flex-wrap gap-2 h-auto bg-transparent mb-8 justify-center", children: SERVICE_DETAILS.map((svc) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        TabsTrigger,
        {
          value: svc.id,
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(svc.icon, { className: "w-4 h-4 mr-2" }),
            svc.label
          ]
        },
        svc.id
      )) }),
      SERVICE_DETAILS.map((svc) => /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: svc.id, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl p-8 shadow-card grid md:grid-cols-2 gap-10 items-start", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 rounded-xl bg-[#0A3D62]/10 flex items-center justify-center mb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(svc.icon, { className: "w-7 h-7 text-[#0A3D62]" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-extrabold text-[#0A3D62] mb-4", children: svc.headline }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 leading-relaxed", children: svc.body })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-[#0A3D62] mb-4 text-sm uppercase tracking-wide", children: "What's Included" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3", children: svc.bullets.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-5 h-5 text-[#1ABC9C] flex-shrink-0 mt-0.5" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-600 text-sm", children: b })
          ] }, b)) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
...
function ProcessSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-24 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16 fade-in-up", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block text-[#1ABC9C] font-semibold text-sm uppercase tracking-widest mb-3", children: "How We Work" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl font-extrabold text-[#0A3D62] mb-4", children: "Our Proven Process" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 max-w-xl mx-auto", children: "A structured, transparent methodology that delivers consistent results—every time." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden lg:block absolute top-10 left-[10%] right-[10%] h-0.5 bg-gradient-to-r from-[#0A3D62] via-[#1ABC9C] to-[#0A3D62] opacity-20" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-5 gap-6", children: PROCESS_STEPS.map((step, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-20 h-20 rounded-full bg-[#0A3D62] flex items-center justify-center mb-4 shadow-lg relative z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(step.icon, { className: "w-8 h-8 text-white" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold text-[#1ABC9C] mb-1 tracking-widest", children: step.step }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-[#0A3D62] text-lg mb-2", children: step.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-xs leading-relaxed", children: step.desc })
          ]
        },
        step.title
      )) })
...
function CTABanner() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20", style: { background: "#0A3D62" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-4 text-center fade-in-up", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl font-extrabold text-white mb-4", children: "Ready to Transform Your Business?" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/70 text-lg mb-8 max-w-xl mx-auto", children: "Partner with Ekan Solutions and let us turn your IT challenges into strategic advantages." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Button,
      {
        size: "lg",
...
function ContactSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", className: "py-24 bg-gray-50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14 fade-in-up", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block text-[#1ABC9C] font-semibold text-sm uppercase tracking-widest mb-3", children: "Get In Touch" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl font-extrabold text-[#0A3D62] mb-4", children: "Contact Us" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 max-w-xl mx-auto", children: "Ready to discuss your project? Reach out and one of our consultants will get back to you within 24 hours." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fade-in-up space-y-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-[#0A3D62] text-xl mb-5", children: "Office Information" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full bg-[#0A3D62]/10 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-5 h-5 text-[#0A3D62]" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold text-gray-800", children: "Maryland Office" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-gray-500 text-sm", children: "Maryland, United States" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full bg-[#0A3D62]/10 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "w-5 h-5 text-[#0A3D62]" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold text-gray-800", children: "Phone Numbers" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "a",
                  {
                    href: "tel:8322950408",
                    className: "block text-gray-500 text-sm hover:text-[#1ABC9C] transition-colors",
                    children: "(832) 295-0408"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "a",
                  {
                    href: "tel:4105968362",
                    className: "block text-gray-500 text-sm hover:text-[#1ABC9C] transition-colors",
                    children: "410-596-8362"
                  }
                )
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full bg-[#0A3D62]/10 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "w-5 h-5 text-[#0A3D62]" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold text-gray-800", children: "Email" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "a",
                  {
                    href: "mailto:info@ekansolutions.com",
                    className: "text-gray-500 text-sm hover:text-[#1ABC9C] transition-colors",
                    children: "info@ekansolutions.com"
                  }
                )
              ] })
            ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#0A3D62] rounded-2xl p-6 text-white", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-lg mb-3", children: "What Happens Next?" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2.5", children: [
            ...
            "li",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-5 h-5 rounded-full bg-[#1ABC9C] text-white text-xs flex items-center justify-center flex-shrink-0 font-bold mt-0.5", children: i + 1 }),
                step
              ]
            },
            step
        ...
        "div",
        {
          ...
          children: submitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-16 h-16 text-[#1ABC9C] mb-4" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-[#0A3D62] text-xl mb-2", children: "Message Sent!" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500", children: "We'll be in touch within 24 hours." })
              ]
            }
          ) : /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "form",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-[#0A3D62] text-xl mb-6", children: "Send Us a Message" }),
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "bg-[#0A3D62] text-white", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 bg-[#1ABC9C] rounded flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { className: "w-5 h-5 text-white" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-lg leading-none block", children: "Ekan Solutions" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-white/50 leading-none", children: "Inc." })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/60 text-sm leading-relaxed mb-5", children: "Enterprise IT services built on 15+ years of expertise. Securing, scaling, and accelerating your business." }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-sm uppercase tracking-widest mb-5 text-[#1ABC9C]", children: "Services" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2.5", children: SERVICES.map((svc) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            href: "#services",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-sm uppercase tracking-widest mb-5 text-[#1ABC9C]", children: "Quick Links" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2.5", children: NAV_LINKS.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            href: link.href,
            className: "text-white/60 text-sm hover:text-[#1ABC9C] transition-colors flex items-center gap-2",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-sm uppercase tracking-widest mb-5 text-[#1ABC9C]", children: "Contact" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3 text-white/60 text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-4 h-4 flex-shrink-0 mt-0.5 text-[#1ABC9C]" }),
            "Maryland, United States"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "w-4 h-4 flex-shrink-0 text-[#1ABC9C]" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-3 text-white/60 text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "w-4 h-4 flex-shrink-0 text-[#1ABC9C]" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href: "mailto:info@ekansolutions.com",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-white/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-white/40 text-xs", children: [
        "© ",
        year,
        " Ekan Solutions Inc. All rights reserved."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-white/40 text-xs", children: [
        "Built with ❤️ using",
        " ",
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen font-sans", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { children: page === "services" ? /* @__PURE__ */ jsxRuntimeExports.jsx(ServicesPage, { setPage }) : page === "about" ? /* @__PURE__ */ jsxRuntimeExports.jsx(AboutPage, { setPage }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(HeroSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(IntroCards, {}),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(ServiceDetails, {}),
